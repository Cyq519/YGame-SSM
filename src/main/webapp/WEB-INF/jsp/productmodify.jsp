			...
			<div class="mysale_center">
				<form id="formmysale"  method="post"  enctype="multipart/form-data">
					<div class="mysale_info">
						...
						<div class="mysale_li">
							<span>商品标题:</span>
							<input maxlength="20" type="text" name="goodsName" class="gsName" id="gsName" value="" placeholder="请输入游戏名字"/>
							<label style="font-size:14px;color:#AAAAAA">请输入商品标题</label>
						</div>
						<div class="mysale_li">
							<span>商品价格:</span>
							<input maxlength="5" type="text" name="goodsPrice" class="gsPrice" id="gsPrice" placeholder="请输入游戏名字"/>
							<label style="font-size:14px;color:#AAAAAA">请输入商品价格</label>
						</div>
						<div class="mysale_li" style="height:150px;">
							<span>商品介绍:</span>
							<textarea style="resize: none" maxlength="50" name="goodsJieShao" class="gsJS" id="gsJS" placeholder="请输入游戏名字"></textarea>
							<label style="font-size:14px;color:#AAAAAA;position:absolute;left:718px;top:480px;">请输入商品介绍</label>
						</div>
						<div class="mysale_li">
							<span>商品数量:</span>
							<input maxlength="3" type="text" name="goodsNumber" class="gsNumber" id="gsNumber" placeholder="请输入游戏名字"/>
